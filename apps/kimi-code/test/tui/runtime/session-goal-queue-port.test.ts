 ...
 * Responsibilities: the Klient adapter preserves parameters, errors, queue order, and copied
 * neutral snapshots without promoting a queued goal. The runtime queue surface is stubbed.
