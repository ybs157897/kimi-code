 ...
 * Responsibilities: the adapter maps the neutral context wire fields, deep-copy history,
 * bind the requested agent, and preserve source errors. The Klient agent facade
 * is the single stubbed boundary.
