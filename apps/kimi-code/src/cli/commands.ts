...
export function createProgram(
  ...
  program
    ...
    .addOption(
      new Option(
        '--agent <name>',
        'Agent profile to use in prompt mode. Custom profiles are discovered from agent directories or loaded via --agent-file.',
      )
    ...
    .addOption(
      new Option(
        '--agent-file <path>',
        'Load an agent definition from a Markdown file and select it in prompt mode.',
      )
        .argParser((value: string, previous: string[] | undefined) => {
