// src/minidb.ts
//
// The MiniDb class: the public embedded database. Ties together the in-memory
// Store (with its ordered key index), the WAL, recovery, compaction, dt-column
// indexes, value secondary indexes, and full-text indexes.
//
// Document model:
...
import type { RecoveryInfo, ValueMode, RecoveredOp } from './recovery.js';
...
import { CODECS } from './value-codec.js';
import type { ValueCodec, ValueCodecName } from './value-codec.js';
import { MAX_KEY_LEN, toBuf, toKStr, fromKStr, canonRange, filterKeys, normDt } from './keys.js';
import { writeFileAtomic, resolveValueMode } from './fs-util.js';
import type {
  ValueModeSetting,
  OpenOptions,
  RestoreOptions,
