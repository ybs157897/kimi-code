...
import type { AcpHost, AcpSessionSummary } from './types';
 ...
 */
function sessionSummaryToSessionInfo(summary: AcpSessionSummary): SessionInfo {
  return {
    sessionId: summary.id,
    cwd: summary.workDir,
    title: summary.title,
...
function toAcpHost(host: AcpHost | KimiHarness): AcpHost {
