...
import type {
  ActivateExpertTeamRpcInput,
  ActivateExtensionCommandRpcInput,
  ActivatePluginCommandRpcInput,
  ActivateSkillRpcInput,
  ImportContextRpcInput,
  ...
  UpdateSessionMetadataRpcInput,
} from '#/sdk-rpc-contract';
import type {
  BeginGlobalMcpServerAuthResult,
  ResolvedCoreAPI,
} from '#/sdk-rpc-core-api';
import { errorMessage } from '#/sdk-rpc-errors';
import type {
  GetCronTasksResult,
