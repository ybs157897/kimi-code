...
import { type ManagedTask, coerceTimeoutSettlement, createForegroundRelease } from './managedTask';
import {
...
import {
  ...
  type AgentTaskNotificationBuildContext,
  NOTIFICATION_FALLBACK_PREVIEW_BYTES,
  agentTaskNotificationChildren,
  buildAgentTaskNotificationBody,
...
import { isAgentTaskTerminal, newerRestoredTask, shouldListTask } from './taskInfo';
import {
  ACTIVE_BACKGROUND_TASK_GUIDANCE,
  ACTIVE_BACKGROUND_TASK_INJECTION_VARIANT,
  isCompactionSplice,
} from './activeTaskReminder';
import { generateTaskId } from './taskId';
import { SESSION_CLOSED_REASON, SIGTERM_GRACE_MS, normalizeReason } from './termination';

export { isAgentTaskTerminal };
