 ...
 *
 * Covers upload → download → delete → 404, large uploads without a size cap,
 * unknown ids, index persistence across restart, the `name` override, and
 * missing-file validation through Fastify injection.
 */
