/**
 * `/api/v1` expert-team routes.
 *
 * These product endpoints resume the addressed Session, borrow its
 * `ISessionExpertTeamService`, and expose the independent expert-team mode
 * without adding swarm fields to legacy session contracts.
 */
...
export function registerExpertTeamsRoutes(app: ExpertTeamRouteHost, core: Scope): void {
