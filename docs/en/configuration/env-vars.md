...
| `KIMI_CODE_EXPERIMENTAL_FLAG` | Enable all registered experimental features for this process. For `kimi` and `kimi -p`, this also selects the experimental v2 engine; `kimi web` already uses v2 without this flag | `1`, `true`, `yes`, `on` |
