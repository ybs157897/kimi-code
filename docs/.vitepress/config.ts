          ...
          '/zh/customization/': [
            {
              ...
              items: [
                ...
                { text: 'Extensions', link: '/zh/customization/extensions' },
          ...
          '/zh/reference/': [
            {
              ...
              items: [
                ...
                { text: 'WorkBuddy 专家与专家团实现', link: '/zh/reference/workbuddy-experts' },
                {
                  ...
                  link: '/zh/reference/workbuddy-agent-teams',
                },
              ],
            },
          ],
          ...
          '/en/customization/': [
            {
              ...
              items: [
                ...
                { text: 'Extensions', link: '/en/customization/extensions' },
                { text: 'Expert teams', link: '/en/customization/expert-teams' },
          ...
          '/en/reference/': [
            {
              ...
              items: [
                ...
                { text: 'WorkBuddy Experts and Expert Teams', link: '/en/reference/workbuddy-experts' },
                {
                  ...
                  link: '/en/reference/workbuddy-agent-teams',
                },
              ],
            },
          ],
